...
const Footer = ({ location, title }) => {
  const { allMarkdownRemark, logoCare, logoHeart, site } = useStaticQuery(
    graphql`
      query FooterQuery {
        logoCare: file(relativePath: { eq: "brand-logo.png" }) {
          ...fluidImage
        }
        logoHeart: file(
          relativePath: { eq: "sfhn-brand-logo-heart-only-white-sized.png" }
        ) {
          ...fluidImage
        }
        site {
                ...
                <div className="footer__content" data-equalizer-watch>
                  ...
                  <div className="map__container">
                    ...
                    >
                      <div
                        className="marker"
                        data-lat="37.755702192657516"
                        data-lng="-122.40509748458862"
                      />
                    </div>
                  </div>
                  <a
